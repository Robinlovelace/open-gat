...
At city scales, interventions in the transport system are most effective when they are placed where they are most needed and account for the geographic distribution of intricate spatial networks and interacting places of transport supply and demand.
...
These premises are described in the wider context of transport planning research.
After outlining the landscape of transport planning software, which is dominated by proprietary products, the paper changes gear.
The focus shifts to open source solutions that enable geographic analysis to be integrated in transport data analysis and modelling workflows.
