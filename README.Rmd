...
Furthermore, in the author's experience, they are difficult to install and use, creating an additional barrier to the integration of geographic analysis in transport planning for people without access to expensive proprietary software.
...
library(fulltext)
ft_search("vissum", from = "crossref", scopusopts = )
scopus_search(query = "vissum", key = Sys.getenv("SCOPUS"))
```
...
[@pappalardo_scikit-mobility:_2019]
