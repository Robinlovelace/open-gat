...
open_tools_filtered %>% 
  ...
  # pack_rows(group_label = "GUI", start_row = 13, end_row = 17) %>%
  # pack_rows(group_label = "WUI", start_row = 18, end_row = 23) %>%
...
Finally, the sDNA QGIS plugin provides an interface to the C++ project sDNA, a tool for spatial network analysis that has been developed to support transport planning for walking and cycling [@cooper_sdna:_2015].
