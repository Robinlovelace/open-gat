...
Before proceeding with the main task of this paper, to review new tools for this growing 'trade', it is worth first taking a step back to think about the key policy drivers of 21^st^ century transport planning.
...
Building on this discussion, Section 6 concludes by returning to the importance of integrating geographic analysis in transport planning workflows, and outlines concrete steps that can be taken to accelerate the transition to open source software in transport planning in support of policies that accelerate the transition away from fossil fuels.
...
In the pre-computing age the relationship between geographic analyis and transport planning was characterised by growing interest in the topic, an understanding of the importance of geographic considerations in the design and evoluation transport systems, but lack of data and computational resources.^[
